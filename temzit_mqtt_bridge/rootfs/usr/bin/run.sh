...
bashio::log.info "Starting Temzit MQTT Bridge v0.2.8"
bashio::log.info "Temzit host: ${TEMZIT_HOST}:${TEMZIT_PORT}"
bashio::log.info "REQCFG polling: every ${TEMZIT_CFG_INTERVAL}s, delay after SYNC ${TEMZIT_CFG_DELAY_AFTER_SYNC}s"
