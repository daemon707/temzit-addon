...
export TEMZIT_DATA_DIR="$(bashio::config 'data_dir')"
export TEMZIT_WRITE_ENABLED="$(bashio::config 'write_enabled')"
...
bashio::log.info "Starting Temzit MQTT Bridge v0.8.6"
...
bashio::log.info "Backup dir: ${TEMZIT_DATA_DIR}"
